...
public abstract class HeronClient2 implements ISelectHandler {
  ...
  private UnixSocketAddress udsEndPoint;
  private SocketChannel udsSocketChannel;
  private boolean createUdsSocket;
   ...
   */
  public HeronClient2(NIOLooper s, String host, int port, HeronSocketOptions options) {
    nioLooper = s;
  ...
  public void start() {
    try {
      ...
      // udsSocketChannel.socket().bind(udsEndPoint);
      // socketChannelHelper = new SocketChannelHelper(
      // nioLooper, this, (SocketChannel)udsSocketChannel, socketOptions);
